package com.example.administrator.myproject.views;
...
import com.example.administrator.myproject.util.AudioManager;
import com.example.administrator.myproject.widget.DialogManager;
 ...
 * @time 2016/6/25 9:26
 */
public class AudioRecorderTextView extends android.support.v7.widget.AppCompatTextView {
    // 按钮正常状态（默认状态）
    ...
    public AudioRecorderTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public interface AudioFinishRecorderCallBack {
        void onFinish(long times, String filePath);
    }
